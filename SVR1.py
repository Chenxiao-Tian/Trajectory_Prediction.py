# -*- coding: utf-8 -*-
"""
Created on Fri Jun 28 11:32:50 2024
...
# 预测路径
def predict_path_svr(start, end, similar_segments, segment_length):
...
for seg_indices in taxi7_segments:
    ...
    predicted_path = predict_path_svr(start, end, similar_segments, segment_length)
