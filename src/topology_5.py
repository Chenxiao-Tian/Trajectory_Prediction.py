# -*- coding: utf-8 -*-
"""
Created on Wed Jun 12 20:33:09 2024
...
# 将 true_path 和 predicted_paths_bridge 中的坐标点映射到道路网络上
snapped_true_path = snap_to_nearest_road(G, data)
...
for j in range(10):  # Reduced the number of plotted paths to 10 for clarity
    ...
    ax.plot(predicted_paths_brownian[j, :, 1], predicted_paths_brownian[j, :, 0], color='green', alpha=0.5, label='Brownian Motion' if j == 0 else "")
