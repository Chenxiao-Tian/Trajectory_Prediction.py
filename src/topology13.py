# -*- coding: utf-8 -*-
"""
Created on Fri Jul 19 21:27:57 2024
...
def resample_true_path(true_path, predicted_paths):
    ...
    return resampled_true_path

resampled_true_path = resample_true_path(data, predicted_paths_bridge)

aee_bridge = calculate_aee_per_step(resampled_true_path, predicted_paths_bridge)
aee_brownian = calculate_aee_per_step(resampled_true_path, predicted_paths_brownian)
...
ax.plot(resampled_true_path[:, 1], resampled_true_path[:, 0], label='True Path', color='blue', linewidth=2)
...
mae_bridge = calculate_mae(resampled_true_path, predicted_paths_bridge)
mae_brownian = calculate_mae(resampled_true_path, predicted_paths_brownian)

mse_bridge = calculate_mse(resampled_true_path, predicted_paths_bridge)
mse_brownian = calculate_mse(resampled_true_path, predicted_paths_brownian)

max_ae_bridge = calculate_max_ae(resampled_true_path, predicted_paths_bridge)
max_ae_brownian = calculate_max_ae(resampled_true_path, predicted_paths_brownian)
