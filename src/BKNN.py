# -*- coding: utf-8 -*-
"""
Created on Sun Jun 30 23:09:30 2024
...
def predict_path(start, end, similar_segments, segment_length):
    ...
    bagging_knn = BaggingRegressor(base_estimator=base_knn, n_estimators=10, random_state=0)
    ...
    predicted_path = bagging_knn.predict(X_pred)
