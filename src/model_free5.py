# -*- coding: utf-8 -*-
"""
Created on Sun Jun 23 20:28:04 2024
...
# 绘制真实路径和预测路径
ax.plot(taxi7[:, 1], taxi7[:, 0], label='True Path', color='blue')
ax.plot(predicted_paths[:, 1], predicted_paths[:, 0], label='Predicted Path', color='red', alpha=0.6)

ax.set_xlabel('Longitude')
ax.set_ylabel('Latitude')
ax.set_title('True Path vs Predicted Path with San Francisco Road Network')
ax.legend()
plt.show()
