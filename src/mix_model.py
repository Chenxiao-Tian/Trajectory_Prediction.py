# -*- coding: utf-8 -*-
"""
Created on Mon Jun 24 12:08:53 2024
...
def build_feature_vectors(data, segments):
    ...
    for seg in segments:
        ...
        features = np.concatenate([start, end, mu, sigma, [passenger_status]])
...
for seg_indices in taxi7_segments:
    ...
    # 构建预测路径段的特征向量
    target_features = np.concatenate([start, end, [0, 0], [0, 0], [passenger_status]])
