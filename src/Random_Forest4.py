...
metrics_rf = calculate_metrics(taxi7, predicted_paths_rf)
metrics_svr = calculate_metrics(taxi7, predicted_paths_svr)

print(f"MAE (Random Forest): {metrics_rf[0]}")
print(f"MSE (Random Forest): {metrics_rf[1]}")
print(f"Max AE (Random Forest): {metrics_rf[2]}")
print(f"Segment Level MAE (Random Forest): {metrics_rf[3]}")
print(f"Segment Level MSE (Random Forest): {metrics_rf[4]}")
print(f"R-squared (Random Forest): {metrics_rf[5]}")

print(f"MAE (SVR): {metrics_svr[0]}")
print(f"MSE (SVR): {metrics_svr[1]}")
print(f"Max AE (SVR): {metrics_svr[2]}")
print(f"Segment Level MAE (SVR): {metrics_svr[3]}")
print(f"Segment Level MSE (SVR): {metrics_svr[4]}")
print(f"R-squared (SVR): {metrics_svr[5]}")
