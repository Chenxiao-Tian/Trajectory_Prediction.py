# -*- coding: utf-8 -*-
"""
Created on Sat Jul 20 19:35:23 2024
...
# -*- coding: utf-8 -*-
"""
Created on Fri Jul 19 22:47:59 2024
...
aee_bridge = calculate_aee_per_step(data, predicted_paths_bridge, timestamps)
aee_brownian = calculate_aee_per_step(data, predicted_paths_brownian, timestamps)

# Calculate segment lengths
true_segment_lengths = calculate_segment_lengths(data, segments)  # Use original data for true segment lengths
...
# Plot true path and segmented Brownian Bridge paths
for j in range(1):  # Reduced the number of plotted paths to 1 for clarity
...
# 计算总的平均AEE
total_aee_bridge = np.mean(aee_bridge)
total_aee_brownian = np.mean(aee_brownian)

print(f"Total Average AEE (Segmented Brownian Bridge): {total_aee_bridge}")
print(f"Total Average AEE (Brownian Motion): {total_aee_brownian}")
...
mae_bridge = calculate_mae(data, predicted_paths_bridge)
mae_brownian = calculate_mae(data, predicted_paths_brownian)

mse_bridge = calculate_mse(data, predicted_paths_bridge)
mse_brownian = calculate_mse(data, predicted_paths_brownian)

max_ae_bridge = calculate_max_ae(data, predicted_paths_bridge)
max_ae_brownian = calculate_max_ae(data, predicted_paths_brownian)
